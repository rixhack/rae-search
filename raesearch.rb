...
while true do
    ...
    response = Typhoeus::Request.post(uri, :timeout => 6, :body =>"TS014dfc77_id=3&TS014dfc77_cr=3a0cccc0e1e18f9816e77a55adeea6cb%3Awvxx%3AVfQv4eTk%3A1795735522&TS014dfc77_76=0&TS014dfc77_86=0&TS014dfc77_md=1&TS014dfc77_rf=0&TS014dfc77_ct=0&TS014dfc77_pd=0")
    s=response.body
    if s==""
